...
We will include all patients age 3-17 undergoing general anesthesia at participating institutions from January 1st, 2015 through January 31st, 2023. Complete inclusion and exclusion criteria are outlined below:
...
In addition to this primary cohort, we are also planning to examine the association between prohpylaxis and PONV outcomes in a more restricted population, isolating only major operative interventions. This more selective cohort would further exclude:

-   Radiation oncology procedures
-   Radiology procedures
-   Non-operative cases
    
Finally, while the MPOG PONV-04 metric explicitly excludes paitents under the age of three, this is not a shared exclusion with the formal published guidelines, which use age < 3 as a sigle risk factor (rather than an exclusion from consideration for prophylaxis). To examine the association of interest more completely and to understand the implications of the guidelines in this younger population, we will also use an expanded cohort of all patients $\leq$ 17 years of age.
